  ...
  <div class="ma-content-block">
    ...
    >
      ...
      <template #operationBeforeExtend="{ record }">
        <a-link
          v-if="!record.disabled && !isRecovery"
          @click="openLeaderModal(record)"
          ><icon-user /> 领导列表</a-link
        >
      </template>
    </sa-table>
...
const options = reactive({
  ...
  delete: {
    ...
    realAuth: ["/admin/dept/realDestroy"],
...
const columns = reactive([
  ...
  { title: "负责人", dataIndex: "head", width: 120 },
